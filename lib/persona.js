		...
		require(['pulling', 'storage'], function (Pulling, Storage) {
			...
			function setupSetting() {
				if (ajaxify.data.template['account/settings'] && !document.getElementById('persona:menus:legacy-layout')) {
					$('<div class="well checkbox"><label><input type="checkbox" id="persona:menus:legacy-layout"/><strong>Inverser les menus sur mobile</strong></label></div>')
						.appendTo('#content .account > .row:first > div:first-child')
						.find('input')
